...
func Test_UserInfo(t *testing.T) {
	...
	expectedResponseadmin := "{\"username\":\"admin\",\"user_id\":2,\"access\":[\"admin\"],\"token\":\"admin\",\"avator\":\"https://avatars0.githubusercontent.com/u/20942571?s=460\\u0026v=4\"}"
	...
	expectedResponsesuper := "{\"username\":\"super_admin\",\"user_id\":1,\"access\":[\"super_admin\",\"admin\"],\"token\":\"super_admin\",\"avator\":\"https://file.iviewui.com/dist/a0e88e83800f138b94d2414621bd9704.png\"}"
